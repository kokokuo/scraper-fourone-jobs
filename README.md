...
**備註** ： 以下開始介紹該「數字求職網站」的分析與破解反爬蟲過程，因為過程可以會對該網站造成營業損失，所以不會全部公開細節與過程，**並請「勿」使用該程式在商業用途**，如有第三人使用本人一蓋不負責。
...
## 免責聲明
若是有人看見此篇，再次強烈提醒該專案與介紹僅為學術研究，「切勿」拿來作為非法用途或使用在商業用途，如使用本人一蓋不負責。
